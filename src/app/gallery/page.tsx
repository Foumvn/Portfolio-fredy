...
import { FullpageLoader } from "@/components/gallery/fullpage-loader"
...
export default function GalleryPage() {
  ...
  const [newProjects, setNewProjects] = useState<(GalleryProject & { isNew?: boolean; isVisible?: boolean })[]>([])
  ...
  const handleCreateProject = useCallback(() => {
    ...
    const newProject: GalleryProject & { isNew: boolean; isVisible?: boolean } = {
